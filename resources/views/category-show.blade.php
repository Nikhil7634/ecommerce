<x-header 
    title="{{ $category->name }} - {{ config('app.name', 'eCommerce') }}"
    description="Browse products in {{ $category->name }} category"
    ...
    <div class="container">
        <div class="row">
                    ...
                    <form method="GET" action="{{ route('category.show', $category->slug) }}" id="filter-form">
                        ...
                        <div class="shop_filter_area">
                                    ...
                                    <li>
                                        <a href="{{ route('category.show', $child->slug) }}" 
                                           class="d-flex justify-content-between align-items-center">
                                            <span><i class="fas fa-angle-right me-2"></i>{{ $child->name }}</span>
                                            <span class="badge bg-primary bg-opacity-10 text-primary">{{ $child->products_count ?? 0 }}</span>
                                        </a>
                                    </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="sidebar_category">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('category.show', $category->parent->slug) }}" class="text-primary">
                                            <i class="fas fa-arrow-left me-2"></i>{{ $category->parent->name }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="mt-4 filter-buttons">
                                ...
                                <a href="{{ route('category.show', $category->slug) }}" class="btn btn-outline-secondary w-100">
            ...
            <div class="col-xxl-10 col-lg-8 col-xl-9">
                <!-- Category Header -->
                <div class="mb-4 category_header">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div class="product_count">
                            <span class="p-3 badge bg-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 col-xl-6 col-md-6">
                            <ul class="product_page_sorting">
                                <li>
                                    <form method="GET" action="{{ route('category.show', $category->slug) }}" class="d-inline">
                    ...
                    <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                        ...
                        @else
                            <div class="py-5 text-center">
                                ...
                                <a href="{{ route('category') }}" class="mt-2 btn btn-primary">
...
<script>
    $(document).ready(function() {
        ...
        $('[name="rating"], [name="on_sale"], [name="in_stock"]').on('change', function() {
            $('#filter-form').submit();
        });
