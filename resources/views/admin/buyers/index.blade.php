            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="mb-20 product-table-quantity d-flex justify-content-between align-items-center">
                        <ul class="mb-0">
                            <li class="text-white">All ({{ $buyers->total() }})</li>
                            <li>Active ({{ $buyers->where('status', 'active')->count() }})</li>
                            <li>Banned ({{ $buyers->where('status', 'banned')->count() }})</li>
                        </ul>
                    ...
                    <table class="table table-dashed table-hover digi-dataTable all-product-table table-striped" id="allProductTable">
                        ...
                        <tbody>
                                        ...
                                        <div class="btn-box">
                                            ...
                                            @if($buyer->status === 'active')
                                                <form action="{{ route('admin.buyers.ban', $buyer) }}" method="POST" style="display:inline">
                                                    @csrf @method('PATCH')
                                                    <button type="submit" class="btn btn-sm btn-icon btn-warning"><i class="fa-light fa-ban"></i></button>
                                                </form>
                                            @else
                                                <form action="{{ route('admin.buyers.unban', $buyer) }}" method="POST" style="display:inline">
                                                    @csrf @method('PATCH')
                                                    <button type="submit" class="btn btn-sm btn-icon btn-success"><i class="fa-light fa-check"></i></button>
                                                </form>
                                            @endif
                                        </div>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="14" class="py-4 text-center">No buyers found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
