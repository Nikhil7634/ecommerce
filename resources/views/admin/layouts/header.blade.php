...
>
    <head>
        ...
        <title>
            Admitro - Bootstrap 5 Premium Admin &amp; Dashboard Template
        </title>
        <meta
            name="Description"
        ...
        <meta
            name="keywords"
            content="dashboard,admin,template dashboard,html css templates,admin panel,admindashboard,dashboard bootstrap 5,html and css,bootstrap admin dashboard,bootstrap 5 admin template,admin panel bootstrap template,admin dashboard,html template,dashboard,template,bootstrap"
        />
        <!-- Favicon -->
        <link
            rel="icon"
            href="{{asset('admin-assets/assets/images/brand-logos/favicon.ico')}}"
            type="image/x-icon"
        />
        <!-- Choices JS -->
        ...
        <link
            id="style"
            href="{{asset('admin-assets/assets/libs/bootstrap/css/bootstrap.min.css')}}"
            rel="stylesheet"
        />
        <!-- Style Css -->
        <link href="{{asset('admin-assets/assets/css/styles.min.css')}}" rel="stylesheet" />
        <!-- Icons Css -->
        <link href="{{asset('admin-assets/assets/css/icons.css')}}" rel="stylesheet" />
        <!-- Node Waves Css -->
        <link href="{{asset('admin-assets/assets/libs/node-waves/waves.min.css')}}" rel="stylesheet" />
        <!-- Simplebar Css -->
        <link
            href="{{asset('admin-assets/assets/libs/simplebar/simplebar.min.css')}}"
            rel="stylesheet"    
        />
        <!-- Color Picker Css -->
        <link
            rel="stylesheet"
            href="{{asset('admin-assets/assets/libs/flatpickr/flatpickr.min.css')}}"
        />
        <link
            rel="stylesheet"
            href="{{asset('admin-assets/assets/libs/@simonwep/pickr/themes/nano.min.css')}}"
        />
        <!-- Choices Css -->
        <link
            rel="stylesheet"
            href="{{asset('admin-assets/assets/libs/choices.js/public/assets/styles/choices.min.css')}}"
        />
        <link
            rel="stylesheet"
            href="{{asset('admin-assets/assets/libs/jsvectormap/css/jsvectormap.min.css')}}"
        />
        <link
            rel="stylesheet"
            href="{{asset('admin-assets/assets/libs/swiper/swiper-bundle.min.css')}}"
        />
    ...
    <body>
        ...
        >
            ...
            <div class="offcanvas-body">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div
                        class="border-0 tab-pane fade show active"
                        id="switcher-home"
                        role="tabpanel"
                    ...
                    >
                        <div>
                            ...
                            <div class="theme-colors">
                                ...
                                <div
                                    class="flex-wrap d-flex align-items-center switcher-style"
                                >
                                    <div class="form-check switch-select me-3">
                                        <input
                                    ...
                                    <div
                                        class="mt-1 form-check switch-select ps-0 color-primary-light"
                                    >
                    ...
                    <div
                        class="flex-wrap d-flex justify-content-between canvas-footer"
                    >
                        <a
                            href="https://1.envato.market/je2eN6"
                            target="_blank"
        ...
        <div id="loader" class="d-none">
            <img src="{{asset('admin-assets/assets/images/media/loader.svg')}}" alt="" />
        </div>
