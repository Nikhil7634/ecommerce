                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control form-control-sm" id="categoryTitle" value="{{ old('name', $category->name) }}" required>
                                @error('name')
                                ...
                                <p class="mt-2 perma-txt">
                                    ...
                                    <span class="text-primary" id="categoryPermalink">
                                        {{ url('category') }}/<span id="slug-preview">{{ $category->slug }}</span>
                                    </span>
                                    <input type="hidden" name="slug" id="categorySlug" value="{{ $category->slug }}">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    @if($category->image)
                                        <img src="{{ Storage::url($category->image) }}" alt="thumb" class="img-thumbnail" style="width:150px;height:150px;object-fit:cover;">
                                    @else
