      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-xxl-8 d-flex align-items-stretch">
            <div class="overflow-hidden card w-100 rounded-4">
              <div class="p-4 card-body position-relative">
                <div class="row">
                  <div class="col-12 col-sm-7">
                    <div class="gap-3 mb-5 d-flex align-items-center">
                      <img src="assets/images/avatars/01.png" class="p-1 rounded-circle bg-grd-info"  width="60" height="60" alt="user">
                      <div class="">
                        <p class="mb-0 fw-semibold">Welcome back</p>
                        <h4 class="mb-0 fw-semibold fs-4">Jhon Anderson!</h4>
                      </div>
                    </div>
                    <div class="gap-5 d-flex align-items-center">
                      <div class="">
                        ...
                        <div class="mb-0 progress" style="height:5px;">
                  ...
                  <div class="col-12 col-sm-5">
                    <div class="pt-4 welcome-back-img">
          ...
          <div class="col-xl-6 col-xxl-2 d-flex align-items-stretch">
            <div class="card w-100 rounded-4">
              <div class="card-body">
                <div class="mb-1 d-flex align-items-start justify-content-between">
                  <div class="">
                ...
                <div class="gap-3 d-flex flex-column">
                  ...
                  <div class="gap-3 d-flex flex-column">
                    <div class="d-flex align-items-center justify-content-between">
                      <p class="gap-2 mb-0 d-flex align-items-center w-25"><span
              ...
              <div class="card-body">
                <div class="gap-3 mb-2 d-flex align-items-center">
                  ...
                  <div class="flex-grow-0">
                    <p
                      class="gap-1 mb-0 rounded dash-lable d-flex align-items-center bg-success text-success bg-opacity-10">
              ...
              <div class="card-body">
                <div class="mb-3 d-flex align-items-start justify-content-between">
                  ...
                  <ul class="list-group list-group-flush">
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-primary">
                            <span class="text-white material-icons-outlined">calendar_today</span>
                          </div>
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-success">
                            <span class="text-white material-icons-outlined">email</span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-branding">
                            <span class="text-white material-icons-outlined">open_in_new</span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-warning">
                            <span class="text-white material-icons-outlined">ads_click</span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-info">
                            <span class="text-white material-icons-outlined">subscriptions</span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-danger">
                            <span class="text-white material-icons-outlined">inbox</span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="px-0 bg-transparent list-group-item">
                        <div class="gap-3 d-flex align-items-center">
                          <div class="wh-42 d-flex align-items-center justify-content-center rounded-3 bg-grd-deep-blue">
                            <span class="text-white material-icons-outlined">visibility</span>
                          </div>
                          <div class="flex-grow-1">
            ...
            <div class="card w-100 rounded-4">
              <div class="card-body">
                ...
                <div class="gap-3 mt-4 d-flex align-items-center">
                  ...
                  <div class="gap-2 d-flex align-items-center align-self-end">
          ...
          <div class="col-xl-6 col-xxl-4 d-flex align-items-stretch">
            <div class="card w-100 rounded-4">
              <div class="card-body">
                ...
                <div class="gap-4 d-flex flex-column justify-content-between">
          ...
          <div class="col-xl-6 col-xxl-4 d-flex align-items-stretch">
            <div class="card w-100 rounded-4">
              <div class="p-3 border-0 card-header border-bottom">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="">
              ...
              <div class="p-3 bg-transparent card-footer">
            ...
            <div class="card w-100 rounded-4">
              <div class="card-body">
               <div class="mb-3 d-flex align-items-start justify-content-between">
                ...
                <div class="my-3 order-search position-relative">
                  <input class="px-5 form-control rounded-5" type="text" placeholder="Search">
                       ...
                       <thead>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>$149</td>
                            <td>Julia Sunota</td>
                            <td><p class="mb-0 dash-lable bg-success bg-opacity-10 text-success rounded-2">Completed</p></td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>$124</td>
                            <td>Julia Sunota</td>
                            <td><p class="mb-0 dash-lable bg-warning bg-opacity-10 text-warning rounded-2">Pending</p></td>
                            <td>
                              <div class="gap-1 d-flex align-items-center">
                                <p class="mb-0">4.0</p>
                                <i class="material-icons-outlined text-warning fs-6">star</i>
                          ...
                          <tr>
                            ...
                            <td>$389</td>
                            <td>Julia Sunota</td>
                            <td><p class="mb-0 dash-lable bg-danger bg-opacity-10 text-danger rounded-2">Canceled</p></td>
                            <td>
                              <div class="gap-1 d-flex align-items-center">
                                <p class="mb-0">2.0</p>
                                <i class="material-icons-outlined text-warning fs-6">star</i>
  ...
  <!--start switcher-->
  <button class="bottom-0 gap-2 m-3 btn btn-grd btn-grd-primary position-fixed end-0 d-flex align-items-center" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop">
      ...
      <div>
        ...
        <div class="row g-3">
          <div class="col-12 col-xl-6">
            ...
            <label class="gap-1 p-4 btn btn-outline-secondary d-flex flex-column align-items-center justify-content-center" for="BlueTheme">
          ...
          <div class="col-12 col-xl-6">
            ...
            <label class="gap-1 p-4 btn btn-outline-secondary d-flex flex-column align-items-center justify-content-center" for="LightTheme">
          ...
          <div class="col-12 col-xl-6">
            ...
            <label class="gap-1 p-4 btn btn-outline-secondary d-flex flex-column align-items-center justify-content-center" for="DarkTheme">
          ...
          <div class="col-12 col-xl-6">
            ...
            <label class="gap-1 p-4 btn btn-outline-secondary d-flex flex-column align-items-center justify-content-center" for="SemiDarkTheme">
          ...
          <div class="col-12 col-xl-6">
            ...
            <label class="gap-1 p-4 btn btn-outline-secondary d-flex flex-column align-items-center justify-content-center" for="BoderedTheme">
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2025 10:31:01 GMT -->
</html>