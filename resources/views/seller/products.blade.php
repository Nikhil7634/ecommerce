      ...
      <div class="row g-3">
        <div class="col-auto">
          <div class="position-relative">
            <input class="px-5 form-control" type="search" placeholder="Search Products">
            <span
        ...
        <div class="col-auto overflow-auto flex-grow-1">
          <div class="btn-group position-static">
            <div class="btn-group position-static">
              <button type="button" class="px-4 btn btn-filter dropdown-toggle" data-bs-toggle="dropdown"
                aria-expanded="false">
                Category
              </button>
        ...
        <div class="col-auto">
          <div class="gap-2 d-flex align-items-center justify-content-lg-end">
            ...
            <button class="px-4 btn btn-primary"><i class="bi bi-plus-lg me-2"></i>Add Product</button>
          </div>
        </div>
      </div><!--end row-->
