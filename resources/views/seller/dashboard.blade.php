        ...
        <div class="col-12 col-xl-8">
          <div class="card w-100 rounded-4">
            <div class="card-body">
              ...
              <div id="chart5"></div>
              <div
                class="gap-3 p-3 mt-3 border d-flex flex-column flex-lg-row align-items-start justify-content-around rounded-4">
            ...
            <div class="card-body">
              ...
              <div class="mb-4">
                <div class="gap-3 d-flex align-items-center">
                  ...
                  <p class="gap-3 mb-0 text-success">27%<span class="material-icons-outlined fs-6">arrow_upward</span>
                  </p>
                </div>
                ...
                <div class="gap-4 d-flex flex-column">
                  <div class="gap-3 d-flex align-items-center">
                    ...
                    <div class="card-lable bg-success text-success bg-opacity-10">
                      <p class="mb-0 text-success">+28.5%</p>
                    </div>
                  </div>
                  <div class="gap-3 d-flex align-items-center">
                    <div class="gap-3 social-icon d-flex align-items-center flex-grow-1">
                  ...
                  <div class="gap-3 d-flex align-items-center">
                    ...
                    <h5 class="mb-0">45,689</h5>
                    <div class="card-lable bg-success text-success bg-opacity-10">
                      <p class="mb-0 text-green">+28.5%</p>
                    </div>
                  </div>
                  <div class="gap-3 d-flex align-items-center">
                    <div class="gap-3 social-icon d-flex align-items-center flex-grow-1">
                  ...
                  <div class="gap-3 d-flex align-items-center">
                    ...
                    <div class="card-lable bg-success text-success bg-opacity-10">
                      <p class="mb-0 text-green">+24.7%</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table class="table mb-0 align-middle table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="card-lable bg-success text-success bg-opacity-10">
                          <p class="mb-0 text-success">Paid</p>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="card-lable bg-danger text-danger bg-opacity-10">
                          <p class="mb-0 text-danger">Unpaid</p>
                        </div>
                      </td>
                      <td>
            ...
            <div class="card-body">
              <div class="mb-3 d-flex align-items-center justify-content-between">
                ...
                <div class="wh-42 d-flex align-items-center justify-content-center rounded-circle bg-grd-danger">
                  <span class="text-white material-icons-outlined fs-5">shopping_cart</span>
                </div>
              </div>
              ...
              <div class="gap-2 mt-3 d-flex align-items-center">
                <div class="card-lable bg-success bg-opacity-10">
                  <p class="mb-0 text-success">+34.7%</p>
                </div>
                ...
                <div class="">
                  ...
                  <div class="gap-3 d-flex align-items-center">
                    ...
                    <div class="card-lable bg-danger bg-opacity-10">
                      <p class="mb-0 text-danger">-26.9%</p>
                    </div>
                  </div>
                </div>
                <div class="dropdown">
