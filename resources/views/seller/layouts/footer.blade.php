  ...
  <!--bootstrap js-->
 <script src="{{ asset('seller-assets/assets/js/bootstrap.bundle.min.js') }}"></script>
...
<!-- main js -->
<script src="{{ asset('seller-assets/assets/js/main.js') }}"></script>
<script src="{{ asset('seller-assets/assets/js/dashboard1.js') }}"></script>
