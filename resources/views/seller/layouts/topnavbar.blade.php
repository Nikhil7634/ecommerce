    ...
    <nav class="gap-4 navbar navbar-expand align-items-center">
      ...
      <div class="search-bar flex-grow-1">
        <div class="position-relative">
          <input class="px-5 form-control rounded-5 search-control d-lg-block d-none" type="text" placeholder="Search">
          ...
          <div class="p-3 search-popup">
            <div class="overflow-hidden card rounded-4">
              <div class="card-header d-lg-none">
                <div class="position-relative">
                  <input class="px-5 form-control rounded-5 mobile-search-control" type="text" placeholder="Search">
      ...
      <ul class="gap-1 navbar-nav nav-right-links align-items-center">
                  ...
                  <div class="mb-0 border shadow-none card rounded-4">
                    <div class="card-body">
                      <div class="gap-3 d-flex align-items-start">
                        <div class="flex-shrink-0 mega-menu-icon bg-danger">
        ...
        <li class="nav-item dropdown">
          <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
             <img src="assets/images/avatars/01.png" class="p-1 border rounded-circle" width="45" height="45" alt="">
          </a>
          <div class="shadow dropdown-menu dropdown-user dropdown-menu-end">
            <a class="gap-2 py-2 dropdown-item" href="javascript:;">
              <div class="text-center">
                <img src="assets/images/avatars/01.png" class="p-1 mb-3 shadow rounded-circle" width="90" height="90"
                  alt="">
